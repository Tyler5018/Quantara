...
app.get('/', async (req, res) => {
    try {
        ...
        // Call 1: Generate the 5 analysis cards
        const chatCompletion = await groq.chat.completions.create({
            messages: [
                { 
                    role: "system", 
                    content: `You are Quantara Core. Output ONLY exactly 5 HTML cards, nothing else. No JSON, no extra text.
        ...
        try {
            ...
            if (pulseParsed.score !== undefined && pulseParsed.label && pulseParsed.summary) {
                pulse = pulseParsed;
            }
        } catch (e) {}
